...
#define		NUMBER_OF_RESERVED_WORDS							14		//保留字个数 ss 最后去掉then时要减一
...
void	InitializeReservedWordTable()//设置保留字单词的名字字符串和相应类型的对照表
{
	...
	strcpy(ReservedWordNameVsTypeTable[13].szName, "else");			ReservedWordNameVsTypeTable[13].eType = ELSE;// ss
}
